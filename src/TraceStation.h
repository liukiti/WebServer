...
#ifndef TRACESTATION_H
#define TRACESTATION_H

#if defined(ARDUINO)
#include <Arduino.h>
#endif /* ARDUINO */

#define TRACESTATION_FIRMWARE_VERSION "0.0-alpha"
#define TRACESTATION_IDENT            "TraceStation-"
